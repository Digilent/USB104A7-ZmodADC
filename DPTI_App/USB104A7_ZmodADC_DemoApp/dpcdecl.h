...
const   ERC ercDabsInitFailed           = 3089; //  Initialization of the DABS library failed
const   ERC ercDpcommInitFailed         = 3090; //  Initialization of the DPCOMM library failed
